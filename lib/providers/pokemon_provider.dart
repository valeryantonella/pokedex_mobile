...
class PokemonProvider extends ChangeNotifier {
  ...
  Pokemon getPokemon(int id) {
    ...
    */
    ...
    return _pokemon.firstWhere((Pokemon pokemon) => pokemon.id==id);
  }
  ...
  /*Future<DocumentSnapshot<Map<String, dynamic>>> getPokemonDocument(int id) async{
    var db = FirebaseFirestore.instance;
  ...
  Future<void> _initPokemonList() async {
    ...
    //20X -> OK
    //40X -> Errores de el lado del cliente (404, 403)
    //50X -> Errores de el lado del servidor (500)
  ...
  void addCommentToPokemon(int id, String comment){
    var db = FirebaseFirestore.instance;
  ...
  Future<void> addPokemonList (String url) async{
    ...
    /*
    var pokeamon = Pokemon(
      id: pokemonData['id'], 
      name: pokemonData['name'], imageUrl: 
